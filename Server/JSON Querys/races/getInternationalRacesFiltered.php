<?php
	...
	$q=mysql_query("SELECT * FROM  `RB_RACE` WHERE `country_code` NOT IN ('".$country->short_name."') AND rbcategoryid = ".$_REQUEST['cat_id']." AND status =1 and date >= subdate(NOW(),1) ORDER BY  `date`");
	$rows = array();
