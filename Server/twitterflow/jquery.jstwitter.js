$(function() {		
	...
	JQTWEET = {
	  ...
	  //  hash: '%23Aguila'			    
	    search: '%23running OR %23corredores OR %23runners OR %23maratonista OR %23justrunners', //leave this blank if you want to show user's tweet
	    user: 'DCComics', //username
	    numTweets: 150, //number of tweets
	    appendTo: '#jstwitter',
	    useGridalicious: true,
	    template: '<div class="item">{IMG}<div class="tweet-wrapper">\
